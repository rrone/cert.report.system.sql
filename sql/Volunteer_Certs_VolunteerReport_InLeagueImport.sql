...
-- ADD COLUMN `Section` TEXT NULL AFTER `SAR`,
-- ADD COLUMN `Area` TEXT NULL AFTER `Section`,
-- ADD COLUMN `Region` TEXT NULL AFTER `Region`;
-- 
-- UPDATE `1.Volunteer_Certs_VolunteerReport_InLeague` 
-- SET 
--     `Section` = SUBSTRING_INDEX(`SAR`, '/', 1);
-- UPDATE `1.Volunteer_Certs_VolunteerReport_InLeague` 
-- SET 
--     `Area` = SUBSTRING_INDEX(`SAR`, '/', 2);
-- UPDATE `1.Volunteer_Certs_VolunteerReport_InLeague` 
-- SET 
--     `Region` = SUBSTRING_INDEX(`SAR`, '/', 3);
